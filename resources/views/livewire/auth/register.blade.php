                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                           ...
                                           value="{{ old('name') }}" wire:model.debounce.1s="name" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="text"
                                           ...
                                           value="{{ old('username') }}" wire:model.debounce.1s="username" required autocomplete="username">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                           ...
                                           value="{{ old('email') }}" wire:model.debounce.1s="email" required autocomplete="email">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                           ...
                                           wire:model.debounce.1s="password" required autocomplete="new-password">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control"
                                           name="password_confirmation" wire:model.debounce.1s="password_confirmation" required autocomplete="new-password">
                                </div>
                            </div>
